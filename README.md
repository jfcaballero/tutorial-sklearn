...
Este repositorio es una versión modificada sobre un breve tutorial sobre ``scikit-learn`` en Python, realizado por https://github.com/pagutierrez y basado en el tutorial de ``scikit-learn`` realizado en la conferencia Scipy2017 (ver referencias).
...
```bash
git clone https://github.com/jfcaballero/tutorial-sklearn
```

Si no estás familiarizado con GitHub o no tienes cuenta, también puedes bajar todo el repositorio como un archivo `.zip`, accediendo a ``Clone or download`` en la cabecera del repositorio (https://github.com/jfcaballero/tutorial-sklearn) y pulsando sobre ``Download ZIP``.
